    ...
    >
      ...
      <div class="flex flex-col gap-2">
        <div
          ...
          :class="{ 'bg-color-2! text-primary-5 dark:text-primary-7 font-bold dark:bg-color-8!': current === item.key }"
